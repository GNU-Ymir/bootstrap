...
morekeywords=[1]{let, is, fn, unsafe, class, struct, in, throw, throws, match, over, pub, prv, prot, self, cte, mod, use, ref, def, with, exit, success, failure, catch, \_\_test, loop}, % if you want to add more keywords to the set
...
language=C,
keywordstyle=[1]\color{purple},       % keyword style
morekeywords=[1]{let, is, fn, unsafe, class, struct, in, throw, throws, match, over, pub, prv, prot, self, cte, mod, use, exit, success, failure, catch, \_\_test, def, ref, loop}, % if you want to add more keywords to the set
