...
morekeywords=[1]{let, is, fn, unsafe, class, struct, in, throw, throws, match, over, pub, prv, prot, self, cte, mod, use, catch, \_\_unittest}, % if you want to add more keywords to the set
...
keywords=[3]{expand, alias, copy, dcopy, ref, mut, dmut, none, null, @union},
