...
morekeywords=[1]{let, is, fn, unsafe, class, struct, in, throw, throws, match, over, pub, prv, prot, self}, % if you want to add more keywords to the set
keywordstyle=[2]\color{PigBlue!80},
keywords=[2]{i32, f32, i8, i16, i64, isize, u8, u16, u32, u64, usize, fsize, f32, f64, c8, c16, c32, Ok, Err},
