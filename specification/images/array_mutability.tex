\begin{center}
  \scalebox{0.7}{
    \begin{tikzpicture}
      ...
      \draw[Box] (3.5, 2.7) -- (3.5, 2.7) node[anchor=center]{\textit{\&}(\emph{foo}) + $24$};

      \draw[-Stealth, thick, shorten >=0.2pt] (7.3, 2.7) to [out=-10,in=20, bend right=45] node[below left, yshift=1mm] {} (7.3, 3.55);

    \end{tikzpicture}
  }
\end{center}
\captionof{figure}{\label{fig:data_repr_array} Example of memory representation of array values}
