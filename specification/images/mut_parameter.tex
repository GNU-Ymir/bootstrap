\begin{adjustbox}{max size=\linewidth}
  \begin{tikzpicture}
    ...
    \draw[line width=1pt] (0.3, 3.4) rectangle (6.8, 1.6);
    \draw[line width=1pt] (0.7, 2.5) rectangle (6.8, 2.5);
  ...
  \end{tikzpicture}
\end{adjustbox}
\captionof{figure}{\label{fig:example_mut_params} Example of a mutable parameter passed by value}
