\begin{figure}[H]
  ...
  \begin{adjustbox}{max size=\linewidth}
    \begin{tikzpicture}
      ...
      \draw[-Stealth](0, 10) -- coordinate (YAx) (0, 3.5);
      \draw[-Stealth](7.2, 10) -- coordinate (YAx) (7.2, 3.5);
      ...
      \draw[Box] (3.5, 6.68) -- (3.5, 6.68) node[anchor=center]{\emph{foo}};
      ...
      \draw[-Stealth](10, 10) -- coordinate (YAx) (10, 3.5);
      \draw[-Stealth](17.2, 10) -- coordinate (YAx) (17.2, 3.5);
  ...
  \end{adjustbox}
  \vspace{-50pt}
  \caption{\label{fig:data_repr_slice}Example of memory representation of slice values}
\end{figure}
\vspace{2pt}
