\begin{center}
  \begin{adjustbox}{max size=\linewidth}
    ...
    \begin{tikzpicture}
      ...
      \draw[Box] (2, 0.4) -- (2, 0.4) node[anchor=center]{let a(\#2) : i32};

      \draw[Box] (-0.5, -1.5) -- (-0.5, -1.5) node[anchor=center]{return 89;};
      \draw[Box] (4.5, -1.5) -- (4.5, -1.5) node[anchor=center]{a(\#2) = 10};

      \draw[Box] (4.5, -3.5) -- (4.5, -3.5) node[anchor=center]{return a(\#2) + 9};
  ...
  \captionof{figure}{\label{fig:if_cond_early_exit} Flow graph representation of the \texttt{if} condition in Listing~\ref{lst:if_cond_early_return}}
\end{center}
