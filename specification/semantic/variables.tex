...
\notebox{
  There are some exceptions to that rule, such as the behavior of
  parameter variables as presented in the next subsection, or iterator variables
  as discussed in Section~\ref{sec:mut_value_iterators}.
}
