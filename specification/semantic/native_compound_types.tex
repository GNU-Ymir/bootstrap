...
assert (!a.hasError && a.hasValue);
  ...
  field \texttt{value} is accessed an exception of type
  \texttt{core::exception::EmptyValOption} is thrown. This exception is of
  ...
  On the other hand, a runtime check is performed when the \texttt{error} field
