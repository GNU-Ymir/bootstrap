...
Figure~\ref{fig:example_call_copy_array} shows the state of the stack when
calling resepctively the function \texttt{foo} at line 10 and the function
\texttt{bar} at line 11. These figures are the abstract depiction of the Ymir
...
\importantbox{ This is not perfect, because a function that is not marked as
  ...
  (e.g., in the next code, the call to \texttt{baz} is considered safe, but
