...
This behavior has other implications, in particular when it involves value
allocations and memory borrowing. In the next example, the variable \token{a}
and \token{b} borrows two different slices, that are constructed when
referencing the name alias \token{A}.
...
\end{lstlisting}
=======
>>>>>>> 303348f1ca3551b6c923b78199848f4a28050f17
