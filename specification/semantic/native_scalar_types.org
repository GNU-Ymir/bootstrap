...
Builtin floating point types conform to the IEEE 754 arithmetic, meaning that
~f32~ have 1 bit of sign, ~8~ bits of exponent, and ~24~ (23 explicit) bits of
mantissa; when ~f64~ type have 1 bit of sign, ~11~ bits of exponent and ~53~ (52
...
during the compilation. Literal have to end with the suffix ~f~ to define ~f32~ literals. All other
literals are considered of type ~f64~. The literal ~4.5e10f~ and ~0.8f~,
~0x1.FFp10f~ are of type ~f32~ when ~4.5e10~ and ~0.8~, ~0x1.FFp10~ are of type
~f64~.
